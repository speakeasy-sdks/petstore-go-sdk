...
func (s *Petstore) AddPet(ctx context.Context, request operations.AddPetRequest) (*operations.AddPetResponse, error) {
...
func (s *Petstore) DeletePet(ctx context.Context, request operations.DeletePetRequest) (*operations.DeletePetResponse, error) {
	baseURL := s._serverURL
...
func (s *Petstore) FindPetByID(ctx context.Context, request operations.FindPetByIDRequest) (*operations.FindPetByIDResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/pets/{id}", request.PathParams)
...
func (s *Petstore) FindPets(ctx context.Context, request operations.FindPetsRequest) (*operations.FindPetsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/pets"
